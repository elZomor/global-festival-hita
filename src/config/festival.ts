...
const configs = {
  arabic: {
    ...
    logo: '🎭',
    apiPrefix: process.env.NEXT_PUBLIC_API_PREFIX ?? '/hita_arab_festival',
  ...
  global: {
    ...
    contactEmail: 'info@play-cast.com',
    logo: '🌍',
    apiPrefix: process.env.NEXT_PUBLIC_API_PREFIX ?? '/global_festival',
    addressAr: 'المعهد العالي للفنون المسرحية\nأكاديمية الفنون\nمصر',
    addressEn: 'Higher Institute of Theatrical Arts\nAcademy of Arts\nEgypt',
  ...
  alt_spaces: {
    abbreviation: 'ASV',
    taglineAr: 'أرشيف نقدي وتوثيقي شامل لمهرجان الفضاء غير التقليدي والقاعات عبر السنوات',
    ...
    titleAr: 'مهرجان الفضاء غير التقليدي والقاعات',
    ...
    aboutWhatIsTitleAr: 'ما هو مهرجان الفضاء غير التقليدي والقاعات؟',
    aboutWhatIsTitleEn: 'What is the Alternative Spaces and Venues Festival?',
    aboutWhatIsTextAr: 'مهرجان الفضاء غير التقليدي والقاعات هو حدث سنوي يستضيفه المعهد العالي للفنون المسرحية، يقدم عروضًا مسرحية في أماكن غير تقليدية.',
