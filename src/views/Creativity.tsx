...
import { mapArticleApiResultToCreativity, type ArticleApiResult, type PaginatedResponse } from '../api/hooks';
import { buildMediaUrl } from '../utils/mediaUtils';
import {FileText} from "lucide-react";

export const Creativity = async () => {
  ...
  const creativityEntries = (response?.results ?? []).map(mapArticleApiResultToCreativity);
